...
Just copy the [`.gitpod.yml`](/.gitpod.yml), [`.gitpod.dockerfile`](/.gitpod.dockerfile) and [`.init.sh`](/.init.sh) to your project root directory and push to your remote repository.
